...
class RRT:
    ...
    def planning(self, animation=True):
        ...
        while(1):
            screen.fill((0,0,0))
            pygame.draw.circle(screen, (0,0, 255), (100*6.67, 100*3.5), 100*1.2)
            pygame.draw.polygon(screen, (0,0, 255), ((100*4.16, 100*100), (100*4.41, 100*100), (100*4.41, 100*3.75) ,(100*4.16, 100*3.75)))
            pygame.draw.polygon(screen, (0,0, 255), ((100*2.5, 0),(100*2.75,0),(100*2.75,100*6.25) ,(100*2.5, 100*6.25)))
    ...
    def check_collision(node):
        ...
        if node.path_x:
            ...
            elif (x-6.67)**2 + (y-6.5)**2 - (1.2)**2 <= 0: 
                print('Circle Up!')

                return False
            
            # Obstacle 2 (Square) 
            elif x >= 4.16 and x <= 4.41 and y >= 0 and y <= 6.75: 
                print('Square!')
     
                return False
            
            # Obstacle 3 (Rectangle Up)
            elif x >= 0 and x <= 2.75 and y >= 3.75 and y >= 0: 
                print('Rectangle Up!')
